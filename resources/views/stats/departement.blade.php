...
@section('title', 'Statistiques par Département')

@section('breadcrumb')
    <span class="text-gray-400">Statistiques</span>
    <i class="fas fa-chevron-right text-xs text-gray-400"></i>
    <span class="text-gray-900 font-semibold">Départements</span>
@endsection
...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Statistiques par Département</h1>
        ...
        <div class="flex flex-col sm:flex-row gap-2 sm:items-center">
            ...
            <form method="GET" action="{{ route('stats.departement') }}" class="inline-flex items-center gap-2">
            ...
            <form method="GET" action="{{ route('stats.departement') }}" class="flex items-center gap-2">
                ...
                <select name="departement_id"
                    ...
                    @foreach(($departements ?? []) as $d)
                        <option value="{{ $d->id }}"
                            {{ (int)($departementId ?? request('departement_id')) === (int)$d->id ? 'selected' : '' }}>
                            {{ $d->nom }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('export.departement.csv', ['departement_id' => ($departementId ?? request('departement_id'))]) }}"
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">Communes du Département</h3>
                <a href="{{ route('export.departement.communes.csv', ['departement_id' => ($departementId ?? request('departement_id'))]) }}"
